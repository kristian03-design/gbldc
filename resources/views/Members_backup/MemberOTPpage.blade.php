...
<head>
  <meta charset="UTF-8" />
  <title>OTP Verification | GBLDC Member</title>
      ...
      <div class="left-content">
        ...
        <div class="logo-area">
          ...
          <div>
            ...
            <div class="logo-sub">Member Portal · OTP Verification</div>
          </div>
        </div>

        <h1 class="headline">Verify your<br><em>Member Login</em></h1>
        ...
        <div class="email-box">
          ...
          <div class="email-box-value">{{ $email ?? session('member_email') }}</div>
        </div>
        ...
        <form action="{{ route('Member.OTP.Confirm') }}" method="POST" id="otpForm" autocomplete="off">
          @csrf
        ...
        <form action="{{ route('Member.OTP.Resend') }}" method="POST">
          @csrf
