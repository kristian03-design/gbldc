...
<head>
  <meta charset="UTF-8" />
  <title>Forgot Password | GBLDC Member</title>
  ...
  <div class="page-wrapper">
    ...
    <div class="left-panel">
      <div class="left-content">
        ...
        <!-- Heading -->
        <h1 class="headline">Forgot your <em>password?</em></h1>
        <p class="subheadline">Enter your email address and we'll send you a link to reset your password securely.</p>
        ...
        <!-- FORM -->
        <form method="POST" action="{{ route('Member.ForgotPassword.Send') }}">
          @csrf
