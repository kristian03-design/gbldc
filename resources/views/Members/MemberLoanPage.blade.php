...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .logo img { width: 46px; height: 46px; padding: 4px; flex-shrink: 0; }
    ...
    .profile-panel {
      ...
      border: 1px solid rgba(22, 163, 74, 0.12); border-radius: 14px;
    ...
    .mobile-nav {
      ...
      position: fixed; inset: 68px 0 0; background: var(--canvas);
      padding: 1.25rem; overflow-y: auto; z-index: 199;
    }
    ...
    .btn-outline svg { width: 14px; height: 14px; stroke: currentColor; fill: none; stroke-width: 2.5; }
    ...
    .btn-cta-white {
      ...
      transition: background 0.2s, transform 0.15s, box-shadow 0.2s; border: none; cursor: pointer;
    }
    ...
    /* ════════════════════ LOGOUT MODAL ════════════════════ */
    .modal-bg {
      position: fixed; inset: 0; background: rgba(26, 46, 30, 0.55); backdrop-filter: blur(4px);
    ...
    .f-brand .logo-badge { width: 40px; height: 40px; padding: 5px; }
...
<section class="cta-strip">
  <div class="container">
    <div class="cta-inner">
      ...
      <p class="cta-sub">You have complete access to our member cooperative loan services. Start your application straight from your dashboard today.</p>
      <div class="cta-btns">
        <form action="{{ route('Redirecting.LoanApp') }}" method="GET" style="display:inline;">
          @csrf
          <input type="text" name="account" value="{{ $user_account ?? '' }}" hidden>
...
<div class="cookie-banner" id="cookieBanner">
  <div class="cb-content">
    ...
    <div class="cb-text">
      ...
      <p>GBLDC uses cookies to ensure you get the best experience on our cooperative portal. By continuing to use our site, you agree to our <a href="{{ route('Member.Policies') }}#cookies">Cookie Policy</a>.</p>
    </div>
  </div>
