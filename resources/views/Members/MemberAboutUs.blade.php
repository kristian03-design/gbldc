  ...
  <div class="container">
    ...
    <div class="services-grid">
      <div class="s-card">
        ...
        <p class="s-desc">As a recognized member of our community, you share directly in our collective success and maintain priority access to our diverse range of services.</p>
        <a href="{{ route('Member.Landing') }}" class="s-link">Your Member Portal <svg viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      </div>
      <div class="s-card">
        ...
        <a href="{{ route('Member.Loans') }}" class="s-link">Learn More <svg viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      </div>
      <div class="s-card">
