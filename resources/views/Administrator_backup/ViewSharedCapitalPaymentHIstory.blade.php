...
<div class="main">
  ...
  <div class="page-body">
    ...
    <div class="page-header">
      <h2>Shared Capital Payment History</h2>
      <p>View all member contributions and payment records for shared capital.</p>
    </div>
    ...
    <div class="table-card">
      <div class="table-card-header">
        ...
        <span class="count-badge">All Transactions</span>
      </div>
