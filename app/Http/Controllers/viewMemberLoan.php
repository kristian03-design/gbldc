...
class viewMemberLoan extends Controller
{
    public function view($loan_number){
        ...
        return view('Administrator.ViewMemberLoan', compact('Review','g1MimeType','g1Base64','g2MimeType',
